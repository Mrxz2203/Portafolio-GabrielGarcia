...
function Footer() {
  const contacts = [
    ...
    },
    {
      ...
      href: "mailto:jarold.pamer@gmail.com",
      type: "email",
      icon: (
    ...
    <footer className="footer-section" id="contacto">
      <div className="footer-container">
        ...
        <p className="footer-contact-description">
          Estoy buscando oportunidades para poder desarrollarme como Ingeniero de Sistemas de Informacion.
          Siempre estaré a dispuesto a colaborar con el crecimiento de la empresa.
        </p>
